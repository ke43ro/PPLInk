...
Partial Class F_FillTables
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtFolder.Text = "Locate the MASTER folder for the song lyrics PowerPoint files, then press Run"
        '
        'txtResults
        '
        ...
        Me.BtnRun.Text = "Run Recreate"
        Me.ToolTip1.SetToolTip(Me.BtnRun, "Run the Recreate program")
