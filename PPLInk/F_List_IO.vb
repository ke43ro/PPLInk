Public Class F_List_IO
    ...
    Private Sub BtnImport_Click(sender As Object, e As EventArgs) Handles BtnImport.Click
        ...
        Else
            MessageBox.Show("This feature can only be run if a file is specified",
                            "PowerPoint Link: Import a list", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        ...
        Do
            ...
            Else
                For Each MatchRow In MatchRows
                    ...
                    'Inactive
                    szOldInact = MatchRow(8)
                    szNewInact = szParts(4)
                    If MatchRow(8) = szParts(4) Then
                    ...
                    'T_filesTableAdapter.Update(MatchRow)
                Next
            End If
        Loop
        ...
        Dim ResultsView As New DataView(T_Results, "", "file_no", DataViewRowState.CurrentRows)
        MessageBox.Show("Results: " & ResultsView.Count)
        'ResultsView.Sort = "file_no"
        ...
        result = MessageBox.Show(szMessage, "PowerPoint link: Import", MessageBoxButtons.YesNo, MessageBoxIcon.Information)
    ...
    Private Sub SaveImportResults(ByRef myTable As DataTable)
        ...
        Try
            ...
            My.Computer.FileSystem.WriteAllText(filePath,
                ...
                False)
        Catch fileException As Exception
            MessageBox.Show("Failed to create file " & filePath, "PowerPoint Link Import Results Save",
                                MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End Try

        Dim myRows() As DataRow = myTable.Select
        MessageBox.Show("This will write " & myRows.Length & " lines to a file " & filePath & " in Documents",
                        "PowerPoint Link Import Results Save", MessageBoxButtons.OK, MessageBoxIcon.Information)
        For Each myRow In myRows
            My.Computer.FileSystem.WriteAllText(filePath,
                ...
                True)
        Next
        MessageBox.Show("File creation complete", "PowerPoint Link Import Results Save", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
End Class